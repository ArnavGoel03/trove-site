...
- Click ripple, in the Screen Studio style, emitting a radial pulse anywhere a mouse-down lands.
- Keystroke overlay: a bottom-center pill showing the last 3 keys pressed, auto-fading.
- Voice-activity auto-pause, which drops the writeable frames to disk only while the mic is hot, saving disk and editor time.
