...
export const metadata: Metadata = {
  title: "Compare Trove — vs CleanShot X, Loom, iStat, Boop, CleanMyMac, asitop, Raycast",
  description:
...
const ROWS: Row[] = [
  ...
  },
  {
    ...
    note: "Boop ships single-op scripts. Trove chains them, saves the chain, replays it.",
  },
  {
    group: "Text + clipboard",
  ...
  },
  {
    ...
    note: "Lower is better in this row. Trove is the only one in this set with zero outbound calls beyond release polling.",
  },
  {
    group: "Platform",
    feature: "Open-source",
  ...
  },
  {
    ...
    note: "Trove: $10/yr. CleanShot $29 one-time. Loom Business $150/yr. iStat $12 one-time. Boop free. CleanMyMac $45/yr. asitop free. Raycast Pro $96/yr.",
  },
];
  ...
  return (
    ...
    >
      <JsonLd
        data={webPageLd(
          "Compare Trove",
          "Side-by-side feature comparison: Trove vs CleanShot X, Loom, iStat Menus, Boop, CleanMyMac, asitop, Raycast.",
