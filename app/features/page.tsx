...
export const metadata: Metadata = {
  ...
  description:
    "All 53 panes in Trove 1.11.2: Clipboard, Compute, Capture, Files, System, Storage. Plus Shortcuts integration, URL scheme verbs, SHA256SUMS verification, saved Text Tools recipes, Homebrew cask, and the sub-500ms cold launch.",
  alternates: {
  ...
  openGraph: {
    title: "Features: every pane in Trove 1.11.2",
    description:
      "All 53 panes plus Shortcuts, URL scheme, SHA256SUMS verify, saved recipes, Homebrew cask.",
