...
const SECTIONS: Sec[] = [
  ...
  },
  {
    ...
    bullets: [
      "Body text: --color-fg (#f5f5f7) on --color-bg (#08080b), ratio 18.9:1",
      "Dimmed text: --color-fg-dim (#a1a1aa) on --color-bg, ratio 8.4:1",
      "Muted text: --color-fg-mute (#71717a) on --color-bg, ratio 4.7:1 (used only on metadata, never on actionable text)",
      `Accent orange (${ACCENT}) is used on background, not on long-form text; when it is used as text (links, eyebrow labels), it's at 14px+ and against the dark surface, 4.8:1`,
