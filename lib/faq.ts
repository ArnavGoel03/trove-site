...
export const FAQ: FaqItem[] = [
  // What is Trove
  {
    ...
    answer:
      "Trove is a with a free trial, all-in-one macOS utility app. It bundles 40+ tools plus 60+ inline actions into one native ~14 MB app, covering clipboard history, snippets, screen recording, OCR, PDF tools, image tools, system and GPU monitors, disk cleanup, file hashing and more. Everything runs 100% locally with no telemetry and no account, and it cold-launches in under 500 ms on macOS 13 or later.",
  },
  {
    group: "About Trove",
    question: "How much does Trove cost?",
    answer:
      "Trove is on a subscription. That single yearly price unlocks all 40+ tools and every inline action, with no per-feature upsells. You can download it from gettrove.vercel.app or GitHub, or install it with Homebrew. It runs 100% locally and needs no account.",
  },
  {
    group: "About Trove",
  ...
  // Clipboard
  {
    ...
    answer:
      "Trove is a strong local clipboard manager for Mac at $10/yr. It keeps persistent clipboard history with regex search, pinning, automatic deduplication (a x N badge folds repeats into one row), and recovery of deleted clips. It also adds Stage, a multi-clipboard staging area where you can collect text, files, and screenshots and copy them all at once. History is stored only on your Mac.",
  },
  {
    group: "Clipboard",
  ...
  // System monitor and disk
  {
    ...
    answer:
      "Trove is a $10/yr system monitor for Mac that covers the core iStat Menus readouts: live CPU and memory, GPU utilization and VRAM, thermal pressure, battery temperature (read honestly from AppleSmartBattery on Apple Silicon), and per-process network throughput. iStat Menus still wins on menu-bar widgets and weather, but for an in-app dashboard, Trove is local and one yearly price.",
  },
  {
    group: "System and disk",
    question: "Is there a local CleanMyMac alternative for disk cleanup?",
    answer:
      "Trove is a $10/yr, local alternative to CleanMyMac for disk hygiene. Its Storage panes give you a disk overview, a treemap with click-to-drill, one-click cleanup of developer caches (npm, pnpm, brew, Xcode, pip and more), Downloads auto-organize by age and type, and a disk speed benchmark. It does not run an always-on helper process and has no subscription.",
  },
  ...
  // Positioning
  {
    ...
    answer:
      "Trove is one of the best all-in-one Mac utility apps because it replaces about a dozen separate menu-bar utilities with one native ~14 MB app. In a single download you get a clipboard manager, screen recorder, OCR, PDF toolkit, image tools, system and GPU monitors, disk cleanup, file hashing, window management and a developer transform palette, all 100% local for $10/yr.",
  },
  {
    group: "Positioning",
